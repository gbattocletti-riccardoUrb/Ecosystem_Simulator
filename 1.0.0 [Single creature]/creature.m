classdef creature < handle & matlab.mixin.Copyable    %enable the possibility of copying the properties of the objects
    
    properties (Constant)
        food_energy_value = 120;
    ...
    methods
        ...
        function obj = random_characteristic_generator(obj, world, N_cycle)     
            ...
            obj.energy_consumption = round(obj.size^3*obj.speed^2 + obj.sense_radius*0.05 ,2);   % sense radius dependence in order to limit it during mutation
            obj.eating_distance = obj.size/2;      
        ...
        function obj = action(obj, world, population)
            ...
            food_position = world.food_vector;                              % all food element positions
        ...
        function obj = death(obj, population)
            ...
            obj.energy_history(Step) = obj.energy;
            population.dead = [population.dead; obj];
            population.dead_position = [population.dead_position; obj.position];
        end
        
        function obj = eat(obj, world)
           world.remove_food(obj.position);                                 % remove food
